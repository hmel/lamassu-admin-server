...
function isEnabled (cryptos, machines, cryptoScope, machineScope, refField) {
...
//         const enabledIf = field.enabledIf
//         const matchesMachine = targetMachine =>
//         field.cryptoScope === 'global'

//         const enabled = !enabledIf || enabledIf.length === 0 ||
//         enabledIf.any(refCode => {

//           const refValues = config.filter(r => r.fieldLocator.code === refCode)
//           return refField.
//         })
//       })
//     })
